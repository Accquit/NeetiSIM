...
export default {
  ...
  theme: {
    extend: {
      ...
      colors: {
        // More sophisticated dark palette
        background: '#0B0F19', // Deep distinct dark
        surface: '#121826',
        primary: {
          DEFAULT: '#6366F1',
          foreground: '#FFFFFF',
      ...
      backgroundImage: {
        ...
        'hero-glow': 'conic-gradient(from 180deg at 50% 50%, #6366F1 0deg, #A855F7 180deg, #38BDF8 360deg)',
      },
      animation: {
